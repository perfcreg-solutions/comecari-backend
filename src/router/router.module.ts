...
import { RoutesCompanyModule } from './routes/routes.company.module';
import { RoutesDriverModule } from './routes/routes.driver.module';
        ...
        if (process.env.HTTP_ENABLE === 'true') {
            imports.push(
                ...
                NestJsRouterModule.register([
                    ...
                    {
                        path: '/company',
                        module: RoutesCompanyModule,
                    },
                    {
                        path: '/driver',
                        module: RoutesDriverModule,
                    }
                ])
            );
        }
